...
class LibroVista extends StatefulWidget {
  const LibroVista({super.key});

  @override
  State<LibroVista> createState() => _LibroVistaState();
}

class _LibroVistaState extends State<LibroVista> {
